...
public class StaticData {
    ...
    private boolean loadOnlineEditions;
    ...
    public StaticData(CardStorageReader cardReader, CardStorageReader customCardReader, String editionFolder, String customEditionsFolder, String blockDataFolder, String cardArtPreference, boolean enableUnknownCards, boolean loadNonLegalCards, boolean loadOnlineEditions) {
        this(cardReader, null, customCardReader, null, editionFolder, customEditionsFolder, blockDataFolder, "", cardArtPreference, enableUnknownCards, loadNonLegalCards, loadOnlineEditions,false, false);
    }

    public StaticData(CardStorageReader cardReader, CardStorageReader tokenReader, CardStorageReader customCardReader, CardStorageReader customTokenReader, String editionFolder, String customEditionsFolder, String blockDataFolder, String setLookupFolder, String cardArtPreference, boolean enableUnknownCards, boolean loadNonLegalCards, boolean loadOnlineEditions, boolean allowCustomCardsInDecksConformance, boolean enableSmartCardArtSelection) {
        ...
        this.loadOnlineEditions = loadOnlineEditions;
        lastInstance = this;
